...
real(rk) ::  const_NC_zoo, const_PC_zoo, g_max, k_grazC, yield_zoo, basal_resp_zoo, mort_zoo, mort_zatt, fT_exp_mort
...
!
type type_maecs_env
 real(rk) :: RNit, nh3, oxy, odu,  temp,par,CO2,doy,att_dep,vphys_dep,GPPR_dep,GPPR_vertint,GPPR_vertint_diag,Denitr_dep,Denitr_vertint,Denitr_vertint_diag,zmax,O2flux_diag
end type
type type_maecs_rhs
