...
type (type_diagnostic_variable_id)   :: id_C2chl, id_fracR, id_fracT, id_fracNU, id_QN, id_QP, id_aVN, id_aVP, id_aVSi, id_faN, id_faP, id_faSi, id_rQSi, id_tmp, id_fac1, id_fac2, id_dPAR, id_phyUR, id_phyELR, id_phyALR, id_phyGLR, id_vsinkr
