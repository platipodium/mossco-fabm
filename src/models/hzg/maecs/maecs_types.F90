...
type (type_diagnostic_variable_id)   :: id_phyqstat, id_chl2, id_fracR, id_rhs_nutN, id_rhs_nutP, id_rhs_nutS, id_rhs_phyC, id_rhs_phyN, id_rhs_phyP, id_rhs_phyS, id_rhs_zooC, id_rhs_detC, id_rhs_detN, id_rhs_detP, id_rhs_detS, id_rhs_domC, id_rhs_domN, id_rhs_domP, id_rhs_Rub, id_rhs_chl
