...
type (type_diagnostic_variable_id)   :: id_GPPR, id_Denitr, id_chl2C, id_fracR, id_fracT, id_Theta, id_fracNU, id_QN, id_QP, id_aVN, id_aVP, id_aVSi, id_faN, id_faP, id_faSi, id_rQSi, id_tmp, id_fac1, id_fac2, id_fac3, id_fac4, id_fac5, id_dPAR, id_phyUR, id_phyELR, id_phyALR, id_phyGLR, id_vsinkr, id_qualPOM, id_qualDOM, id_no3
...
real(rk) ::  P_max, alpha, sigma, theta_LHC, rel_chloropl_min, QN_phy_0, QN_phy_max, V_NC_max, AffN, zeta_CN, zstoich_PN, exud_phy, QP_phy_0, QP_phy_max, V_PC_max, AffP, QSi_phy_0, QSi_phy_max, V_SiC_max, AffSi, syn_nut, adap_rub, adap_theta, tau_regV, disease, phi_agg, agg_doc, sink_phys, vS_phy, vS_det, hydrol, remin, denit, remNP, PON_denit, Q10, T_ref, NutOrder
...
real(rk) ::  PAds, PAdsODU, rnit, ksO2nitri, rODUox, ksO2oduox, ksO2oxic, ksNO3denit, kinO2denit, kinNO3anox, kinO2anox, kanammox
...
!
type type_maecs_env
 real(rk) :: RNit, fdet, nh3, oxy, odu,  temp,par,doy,GPPR_dep,GPPR_vertint,GPPR_vertint_diag,Denitr_dep,Denitr_vertint,Denitr_vertint_diag,zmax,O2flux_diag
end type
type type_maecs_rhs
