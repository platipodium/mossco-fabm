...
!!----------------------------------------------------------------------
! standard fabm model types
type (type_state_variable_id)        :: id_nutN,id_nutP,id_nutS,id_phyC,id_phyN,id_phyP,id_phyS,id_zooC,id_detC,id_detN,id_detP,id_detS,id_domC,id_domN,id_domP,id_RNit,id_Rub,id_chl,id_fdet,id_nh3,id_oxy,id_odu
type (type_dependency_id)            :: id_temp
type (type_dependency_id)            :: id_par
type (type_global_dependency_id)            :: id_doy
type (type_dependency_id)            :: id_totC
type (type_horizontal_dependency_id)            :: id_totC_vertmean
type (type_dependency_id)            :: id_totN
type (type_horizontal_dependency_id)            :: id_totN_vertmean
type (type_dependency_id)            :: id_totP
type (type_horizontal_dependency_id)            :: id_totP_vertmean
type (type_dependency_id)            :: id_totS
type (type_horizontal_dependency_id)            :: id_totS_vertmean
type (type_horizontal_diagnostic_variable_id)            :: id_totC_vertmean_diag
type (type_horizontal_diagnostic_variable_id)            :: id_totN_vertmean_diag
type (type_horizontal_diagnostic_variable_id)            :: id_totP_vertmean_diag
type (type_horizontal_diagnostic_variable_id)            :: id_totS_vertmean_diag
type (type_horizontal_dependency_id)            :: id_zmax
type (type_horizontal_diagnostic_variable_id)            :: id_O2flux_diag
!diagnostics variables for which the vertical means should be calculated:
type (type_dependency_id)            :: id_GPPR_dep
type (type_horizontal_dependency_id)            :: id_GPPR_vertmean
type (type_horizontal_diagnostic_variable_id)            :: id_GPPR_vertmean_diag

type (type_diagnostic_variable_id)   :: id_chl2C, id_fracR, id_fracT, id_Theta, id_fracNU, id_QN, id_QP, id_aVN, id_aVP, id_aVSi, id_faN, id_faP, id_faSi, id_rQSi, id_tmp, id_fac1, id_fac2, id_fac3, id_fac4, id_fac5, id_dPAR, id_phyUR, id_phyELR, id_phyALR, id_phyGLR, id_vsinkr, id_sdet, id_no3, id_Denitr, id_GPPR, idNCPR
real(rk) ::  nutN_initial, nutP_initial, nutS_initial, phyC_initial, phyN_initial, phyP_initial, phyS_initial, zooC_initial, detC_initial, detN_initial, detP_initial, detS_initial, domC_initial, domN_initial, domP_initial, RNit_initial, frac_Rub_ini, frac_chl_ini, fdet_initial, nh3_initial, oxy_initial, odu_initial
...
real(rk) ::  a_water, a_minfr, a_spm, a_chl, frac_PAR, small, dil, ex_airsea, O2_sat, N_depo, P_depo
...
!
type type_maecs_env
 real(rk) :: RNit, fdet, nh3, oxy, odu,  temp,par,doy,zmax,O2flux_diag
end type
type type_maecs_rhs
 real(rk) :: nutN,nutP,nutS,phyC,phyN,phyP,phyS,zooC,detC,detN,detP,detS,domC,domN,domP,RNit,Rub,chl,fdet,nh3,oxy,odu
end type
! standard fabm model types
!#SP#
