...
type (type_diagnostic_variable_id)   :: id_chl2, id_fracR, id_QN, id_QP, id_tmp, id_fac1, id_fac2, id_aVN, id_aVP
type (type_conserved_quantity_id)    :: id_totC, id_totN, id_totP, id_totS
