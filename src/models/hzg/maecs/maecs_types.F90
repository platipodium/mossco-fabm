...
type (type_diagnostic_variable_id)   :: id_C2chl, id_fracR, id_fracT, id_Theta, id_fracNU, id_QN, id_QP, id_aVN, id_aVP, id_aVSi, id_faN, id_faP, id_faSi, id_rQSi, id_tmp, id_fac1, id_fac2, id_fac3, id_fac4, id_fac5, id_dPAR, id_phyUR, id_phyELR, id_phyALR, id_phyGLR, id_vsinkr
...
!
type type_maecs_env
 real(rk) :: RNit,temp,par
end type
type type_maecs_rhs
 real(rk) :: RNit,nutN,nutP,nutS,phyC,phyN,phyP,phyS,zooC,detC,detN,detP,detS,domC,domN,domP,Rub,chl
end type
! standard fabm model types
!#SP#
