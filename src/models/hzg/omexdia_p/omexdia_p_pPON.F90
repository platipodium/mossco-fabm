...
!     Variable identifiers
      ...
      type (type_diagnostic_variable_id)   :: id_denit,id_adsp,id_bPON
...
!BOC
   ...
   call self%register_diagnostic_variable(self%id_bPON,'bPON','mmol/m**3/d', &
         'benthic particulate organic nitrogen', output=output_instantaneous)
...
!   _SET_ODE_(self%id_nh3 , (Nprod - Nitri) / (1.0_rk + self%NH3Ads) _CONV_UNIT_)
   ...
   _SET_DIAGNOSTIC_(self%id_bPON ,fdet*self%NCrFdet + sdet*self%NCrSdet)
